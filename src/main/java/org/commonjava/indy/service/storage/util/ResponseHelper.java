 ...
 */
package org.commonjava.indy.service.storage.util;
...
public class ResponseHelper
{
    ...
    public Response formatCreatedResponseWithJsonEntity( final URI location, final Object dto ) throws JsonProcessingException {
    ...
    public Response formatCreatedResponseWithJsonEntity( final URI location, final Object dto,
                                                         final Consumer<ResponseBuilder> builderModifier ) throws JsonProcessingException {
        ...
        else
        {
            builder = Response.created( location )
                              .entity( mapper.writeValueAsString(dto) )
    ...
    public Response formatOkResponseWithJsonEntity( final Object dto ) throws JsonProcessingException {
        return formatOkResponseWithJsonEntity( dto, null );
    }

    public Response formatOkResponseWithJsonEntity( final Object dto, final Consumer<ResponseBuilder> builderModifier ) throws JsonProcessingException {
        if ( dto == null )
        {
        ...
        ResponseBuilder builder =
                Response.ok( mapper.writeValueAsString(dto), APPLICATION_JSON );
